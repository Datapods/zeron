...
Organize, Sort, Show, and Layout open nested menus using the same popup component
as the model selector. The parent summarizes current choices. Radio choices close
the child; Show and Compact toggles stay open for repeated changes.
...
arrow-key navigation and sort selection, Escape, and outside-click dismissal.
